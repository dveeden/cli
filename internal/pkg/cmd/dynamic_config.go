...
func NewDynamicConfig(config *v1.Config, resolver FlagResolver, client *ccloud.Client, MDSv2ApiClient *mdsv2.APIClient) *DynamicConfig {
...
func (d *DynamicConfig) FindContext(name string) (*DynamicContext, error) {
	...
	return NewDynamicContext(ctx, d.Resolver, d.Client, d.MDSv2ApiClient), nil
}
...
func (d *DynamicConfig) Context() *DynamicContext {
	...
	return NewDynamicContext(ctx, d.Resolver, d.Client, d.MDSv2ApiClient)
}
