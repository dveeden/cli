...
func (s *SchemaRegistryService) CreateSchemaRegistryCluster(_ context.Context, config *SchemaRegistryClusterConfig) (*SchemaRegistryCluster, error) {
...
func (s *SchemaRegistryService) GetSchemaRegistryClusters(_ context.Context, cluster *SchemaRegistryCluster) ([]*SchemaRegistryCluster, error) {
...
func (s *SchemaRegistryService) GetSchemaRegistryCluster(_ context.Context, cluster *SchemaRegistryCluster) (*SchemaRegistryCluster, error) {
...
func (s *SchemaRegistryService) UpdateSchemaRegistryCluster(_ context.Context, cluster *SchemaRegistryCluster) (*SchemaRegistryCluster, error) {
...
func (s *SchemaRegistryService) DeleteSchemaRegistryCluster(_ context.Context, cluster *SchemaRegistryCluster) error {
