...
require (
	...
	github.com/confluentinc/ccloud-sdk-go-v1 v0.0.98
...
require (
	...
	github.com/confluentinc/ccloud-sdk-go-v2/iam v0.6.0 // indirect
	github.com/confluentinc/ccloud-sdk-go-v2/mds v0.4.0 // indirect
